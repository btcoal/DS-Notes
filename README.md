...
- [Gradient Descent and Backpropagation](gradient-descent-and-backprop.md)
...
- [ViTs](vits.md) (*only because it's on your resume*)
...
- [Time Series Forecasting, Deep Learning](time-series-forecasting-deep-learning.md)
- [Time Series Forecasting with LLMs](time-series-forecasting-llms.md)
- [Clustering](clustering.md)
- [Time Series Causality](time-series-causality.md)
...
- [Search, Retrieval, and Ranking](search-retrieval-ranking.md)
- [Inference Efficiency](inference-efficiency.md)

## C Tier
- [Confidence Scores for LLMs](confidence-scores-for-llms.md)
...
- [Monitoring and Obserability](monitoring-and-observability.md)
- [Flow Matching](flow-matching.md)
- [Training Large Models](training-large-models.md)
- [GANs](gans.md)
